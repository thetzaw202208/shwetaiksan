...
class _ApiService implements ApiService {
  ...
  @override
  Future<TwoResultApiResponse> getResult() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<TwoResultApiResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = TwoResultApiResponse.fromJson(_result.data!);
    return value;
  }

  @override
  Future<LiveResultApiResponse> live() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<LiveResultApiResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = LiveResultApiResponse.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<GetBalanceResponseVo> getUserBalance(String phone) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'phone': phone};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<GetBalanceResponseVo>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'application/x-www-form-urlencoded',
    ...
    final value = GetBalanceResponseVo.fromJson(_result.data!);
    return value;
  }
